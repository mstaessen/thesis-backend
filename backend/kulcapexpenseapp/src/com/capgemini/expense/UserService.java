...
public class UserService {
    ...
    static {
        ...
        Employee emp3 = new Employee(3, "test123", "Sander", "Van Loock", "sander.vanloock1@student.kuleuven.be‎", "4205", 3, "user");
    ...
    public String login(@FormParam("email") String email, @FormParam("password") String password,
        ...
        while (it.hasNext()) {
            ...
            if (StringUtils.areStringsEqual(emp.getEmail(), email)
                    && StringUtils.areStringsEqual(emp.getPassword(), password)) {
    ...
    @OPTIONS
    @Path("/getEmployee")
    public void getEmployee(@FormParam("token") String token, @Context HttpServletResponse response,
            @Context HttpServletRequest req) {
        ServiceUtils.prepareOptionsResponse(response);
    }
