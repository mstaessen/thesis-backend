...
public class PDFUtil {
    ...
    public static void generatePdf(ExpenseForm form, Employee emp, OutputStream out) throws DocumentException {
        ...
        // step 4
        document.add(new Paragraph("Expense note from: " + emp.getLastName() + ", " + emp.getFirstName() + " - emp°: "
                + emp.getEmployeeNumber() + " - unit: " + Unit.getById(emp.getUnitId()), fontbold));
        document.add(Chunk.NEWLINE);
        document.add(new Paragraph("Month: " + form.getDate().getMonth() + ", year: "
                + (form.getDate().getYear() + 1900)));
        document.add(Chunk.NEWLINE);
